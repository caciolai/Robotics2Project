...
%% Direct kinematics
tic
% DH table for elbow-type 3R robot
...
% A_i homogeneous transformation matrix from RF_{i-1} to RF_i
A = zeros([4 4 n], 'sym');
for i=1:n
...
rc(:, 1) = [0 -d(1) 0]'; % along y axis since alpha_1 = pi/2
rc(:, 2) = [-d(2) 0 0]'; 
rc(:, 3) = [-d(3) 0 0]';
...
r(:, 1) = [0 l(1) 0]'; % along y axis since alpha_1 = pi/2
r(:, 2) = [l(2) 0 0]'; 
r(:, 3) = [l(3) 0 0]';
